var ActivitiRest = {
	...
	getProcessDefinitionByKey: function(processDefinitionKey, callback) {
		...
		$.ajax({
			...
			console.error('Get diagram layout0['+processDefinitionKey+'] failure: ', textStatus, 'error: ', error, jqXHR);
		});
	},
	...
	getProcessDefinition: function(processDefinitionId, callback) {
		...
		$.ajax({
			...
			console.log(jqXHR)
			console.log('Get diagram layout1['+processDefinitionId+'] failure: ', textStatus, jqXHR);
		});
	},
